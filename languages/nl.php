...
$language = array (
  ...
  'event_manager:event:menu:user_hover:move_to_waitinglist' => 'Verplaats naar wachtlijst',
  ...
  'event_manager:action:move_to_waitinglist:success' => 'Gebruiker is verplaatst naar de wachtlijst',
...
Indien u zich niet heeft geregistreerd kunt u deze email negeren of de link volgen, waar u de mogelijkheid heeft om de registratie te verwijderen.',
  ...
  'event_manager:tab:profile' => 'Profiel',
  'event_manager:tab:location' => 'Locatie',
  'event_manager:tab:registration' => 'Registratie',
  ...
  'event_manager:event:exportwaitinglist' => 'Exporteer wachtlijst',
  ...
  'event_manager:action:registration:edit:error_required_slots' => 'Niet alle sloten zijn ingevuld. Let erop dat het verplicht is om voor ieder slot een keuze te maken.',
...
Iemand heeft zich afgemeld van het \'%s\' evenement. Je bent van de wachtlijst naar de deelnemers verplaatst.',
  ...
  'event_manager:list:navigation:all' => 'Alle evenementen',
  ...
  'event_manager:edit:form:with_program' => 'Dagprogramma aanmaken?',
  'event_manager:edit:form:require_slots' => 'Verplicht deelnemers om alle sloten in te vullen',
  'event_manager:slots:explanation' => 'Dit programma bevat sloten. Je kunt maar één activiteit per slot kiezen.',
  'event_manager:slots:required' => 'Verder is het verplicht om alle sloten in te vullen.',
  ...
  'event_manager:edit:form:registration_confirmation' => 'Tekst toevoegen aan registratie bevestigingsmail',
  'event_manager:edit:form:registration_confirmation:description' => 'Deze optie maakt het mogelijk om een eigen tekst toe te voegen aan de registratiebevestiging.',
  ...
  'event_manager:editregistration:commasepetared' => 'comma gescheiden',
...
',
  ...
  'event_manager:event:editevent' => 'Wijzig evenement',
  ...
  'event_manager:event:file:notfound:title' => 'Bestand niet gevonden',
  ...
  'event_manager:login_needed' => 'Je bent niet ingelogd',
  'event_manager:event_not_found' => 'Evenement niet gevonden.',
  'event_manager:relationship_type_not_found' => 'Relatie type niet gevonden.',
  'event_manager:error:max_attendees:not_numeric' => '\'Maximum aantal deelnemers\' is geen geldig nummer.',
  ...
  'event_manager:event:rsvp:event_full' => 'Evenement is vol',
